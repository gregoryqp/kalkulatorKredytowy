...
let wnioskowanaKwota = document.querySelector(".kwotaWnioskowana");
let kwotaDoWyplaty = document.querySelector(".kwotaDoWyplaty");
let calkowityKoszt = document.querySelector(".calkowityKosztKredytu");
let koszt;

sliderValue.innerHTML = sliderValueAtribute;
wnioskowanaKwota.innerHTML = kwotaDoWyplaty.innerHTML =
